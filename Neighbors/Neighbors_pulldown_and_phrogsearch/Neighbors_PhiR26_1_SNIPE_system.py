...
PhiR26_1_SNIPE_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/single_gene_systems_nr/TaxIDswPhiR26_1_SNIPE_system_nr_dom_filtered_prot.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(PhiR26_1_SNIPE_hits['Featuretable'], PhiR26_1_SNIPE_hits['Prot_ID']))
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        PhiR26_1_SNIPE_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in PhiR26_1_SNIPE_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            PhiR26_1_SNIPE_system_IDs = all_prots.intersection(PhiR26_1_SNIPE_systems)
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(PhiR26_1_SNIPE_system_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/PhiR26_1_Snipe_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'PhiR26_1_SNIPE_system_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'PhiR26_1_SNIPE_system_neighbors_detailed_summary.csv')
...
matches = PhiR26_1_SNIPE_matches
