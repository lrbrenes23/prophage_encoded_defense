...
PhiR12_1_cIoperonic_system_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/single_gene_systems_nr/TaxIDswPhiR12_1_cIoperonic_system_nr_dom_filtered_prot.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(PhiR12_1_cIoperonic_system_hits['Featuretable'], PhiR12_1_cIoperonic_system_hits['Prot_ID']))
...
PhiR12_1_cIoperonic_system_matches = {}
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        PhiR12_1_cIoperonic_system_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in PhiR12_1_cIoperonic_system_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            PhiR12_1_cIoperonic_system_system_IDs = all_prots.intersection(PhiR12_1_cIoperonic_systems)
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(PhiR12_1_cIoperonic_system_system_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/PhiR12_1_cIoperonic_system_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'PhiR12_1_cIoperonic_system_system_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'PhiR12_1_cIoperonic_system_system_neighbors_detailed_summary.csv')
...
matches = PhiR12_1_cIoperonic_system_matches
