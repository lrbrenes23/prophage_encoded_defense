...
DUF_12_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/multi_gene_systems_nr/TaxIDs_nr_PhiR12_1_DUF_system.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(DUF_12_hits['Featuretable'], DUF_12_hits['Prot_ID']))
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        DUF_12_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in DUF_12_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(PhiR12_1_DUF_system_DUF1327_IDs | PhiR12_1_DUF_system_DUF1823_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/PhiR12_1_DUF_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'PhiR12_1_DUF_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'PhiR12_1_DUF_neighbors_detailed_summary.csv')
