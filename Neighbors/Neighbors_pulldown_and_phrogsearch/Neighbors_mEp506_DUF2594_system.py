...
mEp506_small_sys_DUF2594_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/multi_gene_systems_nr/TaxIDs_nr_mEp506_small_sys_DUF2594s_nr_dom_filtered_STRINGENT.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(mEp506_small_sys_DUF2594_hits['Featuretable'], mEp506_small_sys_DUF2594_hits['Prot_ID']))
...
mEp506_small_sys_DUF2594_matches = {}
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        mEp506_small_sys_DUF2594_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in mEp506_small_sys_DUF2594_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            mEp506_small_sys_DUF2594_system_IDs = all_prots.intersection(mEp506_small_sys_DUF2594s)
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(mEp506_small_sys_DUF2594_system_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/mEp506_small_sys_DUF2594_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'mEp506_small_sys_DUF2594_system_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'mEp506_small_sys_DUF2594_system_neighbors_detailed_summary.csv')
...
matches = mEp506_small_sys_DUF2594_matches
