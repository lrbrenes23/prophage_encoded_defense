...
mEp332_cIoperonic_homolog_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/single_gene_systems_nr/TaxIDswmEp332_cIoperonic_homolog_system_nr_dom_filtered_prot.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(mEp332_cIoperonic_homolog_hits['Featuretable'], mEp332_cIoperonic_homolog_hits['Prot_ID']))
...
mEp332_cIoperonic_homolog_matches = {}
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        mEp332_cIoperonic_homolog_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in mEp332_cIoperonic_homolog_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            mEp332_cIoperonic_homolog_system_IDs = all_prots.intersection(mEp332_cIoperonic_homolog_systems)
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(mEp332_cIoperonic_homolog_system_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/mEp332_cIoperonic_homolog_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'mEp332_cIoperonic_homolog_system_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'mEp332_cIoperonic_homolog_system_neighbors_detailed_summary.csv')
...
matches = mEp332_cIoperonic_homolog_matches
