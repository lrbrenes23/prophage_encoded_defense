...
PhiR44_1_MorcDcm_hits=pd.read_csv('/home/gridsan/lbrenes/hhpred/taxids/multi_gene_systems_nr/TaxIDs_nr_PhiR44_1_MorcDcm_system.csv')

# Step 2: Make a dictionary connection between the FT and Prot ID column values
FT_Prot_ID_match = dict(zip(PhiR44_1_MorcDcm_hits['Featuretable'], PhiR44_1_MorcDcm_hits['Prot_ID']))
...
for Featuretable in os.listdir(all_FT_files_dir):
    if Featuretable in FT_Prot_ID_match:
        ...
        PhiR44_1_MorcDcm_matches[Featuretable] = Prot_ID
...
def neighbors(directory, matches):
    ...
    for Featuretable, Prot_ID in PhiR44_1_MorcDcm_matches.items():
        ...
        if os.path.isfile(FT_file_path):
            ...
            if not matched_rows.empty:
                ...
                for idx in matched_indices:
                    ...
                    neighbor_rows = neighbor_rows[~neighbor_rows['non-redundant_refseq'].isin(PhiR44_1_MorcDcm_system_Morc_IDs | PhiR44_1_MorcDcm_system_Dcm_IDs)]
...
def save_results(results):
    ...
    output_dir = '/home/gridsan/lbrenes/hhpred/neighbors/PhiR44_1_MorcDcm_system'
    ...
    refseq_summary_file = os.path.join(output_dir, 'PhiR44_1_MorcDcm_system_neighbors_prot_refseq_summary.csv')
    ...
    detailed_summary_file = os.path.join(output_dir, 'PhiR44_1_MorcDcm_system_neighbors_detailed_summary.csv')
...
matches = PhiR44_1_MorcDcm_matches
